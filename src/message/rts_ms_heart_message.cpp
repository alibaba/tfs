...
namespace tfs
{
  namespace message
  {
    RtsMsHeartMessage::RtsMsHeartMessage():
      keepalive_type_(common::RTS_MS_KEEPALIVE_TYPE_LOGIN)
    {
      _packetHeader._pcode = common::REQ_RT_MS_KEEPALIVE_MESSAGE;
    }
    ...
    int RtsMsHeartMessage::deserialize(common::Stream& input)
    {
      int64_t pos = 0;
    ...
    int RtsMsHeartMessage::serialize(common::Stream& output) const 
    {
      int64_t pos = 0;
    ...
    RtsMsHeartResponseMessage::RtsMsHeartResponseMessage():
      ...
      lease_expired_time_(common::RTS_MS_LEASE_EXPIRED_TIME_DEFAULT),
      ret_value_(common::TFS_ERROR),
      renew_lease_interval_time_(common::RTS_MS_RENEW_LEASE_INTERVAL_TIME_DEFAULT)
    {
      _packetHeader._pcode = common::RSP_RT_MS_KEEPALIVE_MESSAGE;
    }
    ...
    int RtsMsHeartResponseMessage::deserialize(common::Stream& input)
    {
    ...
    int RtsMsHeartResponseMessage::serialize(common::Stream& output) const 
    {
